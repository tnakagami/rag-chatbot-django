# Generated by Django 4.2.13 on 2024-05-08 16:36
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('chatbot', '0002_alter_embedding_emb'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            name='config',
            field=models.JSONField(blank=True, default='', help_text='Required: JSON format', null=True, verbose_name='Config'),
        ),
        migrations.AlterField(
