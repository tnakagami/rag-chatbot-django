# Generated by Django 4.2.13 on 2024-05-12 22:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('config', models.JSONField(blank=True, default=dict, help_text='Required: JSON format', null=True, verbose_name='Config')),
            ],
        ),
        migrations.CreateModel(
            name='DocumentFile',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, help_text='255 characters or fewer.', max_length=255, verbose_name='Document name')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('docfiles', models.ManyToManyField(blank=True, related_name='docfiles', to='chatbot.documentfile', verbose_name='Document files used in RAG')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assistant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='embedding_stores', to='chatbot.assistant', verbose_name='Base assistant of embedding store')),
                ('docfile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='embedding_stores', to='chatbot.documentfile', verbose_name='Base document file of embedding store')),
            ],
        ),
        migrations.CreateModel(
            name='Tool',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emb_type', models.IntegerField(choices=[(1, 'Open AI'), (2, 'Azure'), (4, 'Amazon Bedrock'), (5, 'Fireworks (Mixtral)'), (6, 'Ollama'), (7, 'GEMINI')], default=1, verbose_name='Embedding type')),
